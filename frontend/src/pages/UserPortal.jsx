  ...
  useEffect(() => {
    const loadMatches = async () => {
      try {
        ...
        setError(
          "Unable to load matches at this time. Please try again later.",
        );
      } finally {
        setIsLoading(false);
      }
            ...
            >
              ...
              <div className="md:w-[45%] p-8 md:p-12 flex flex-col justify-center">
                ...
                <h2 className="text-3xl md:text-4xl font-extrabold text-slate-900 tracking-tight leading-tight mb-4">
                  ...
                  <span className="text-slate-400 font-medium text-2xl mx-1">
                    vs
                  </span>{" "}
                ...
                <p className="text-slate-500 text-sm md:text-base leading-relaxed mb-8 line-clamp-3">
                  {selectedMatch.description ||
                    "Experience the thrill of live cricket. Book your seats now for an unforgettable match-day experience."}
                </p>
                  ...
                  >
                    ...
                    <div className="p-5 flex-grow flex flex-col">
                      ...
                      <p className="text-xs text-slate-500 line-clamp-2 mb-4">
                        {match.description ||
                          "Join the excitement and cheer for your favorite team."}
                      </p>
