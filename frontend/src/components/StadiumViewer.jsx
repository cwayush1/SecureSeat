              ...
              >
                <div style={{ marginBottom: "16px" }}>
                  <svg
                    ...
                    style={{ margin: "0 auto", color: t.primaryBlue }}
                  >
                    <path
                ...
                >
                  Select a stand to view details
                </p>
                <p
                  style={{
                    fontFamily: "Inter",
                ...
                >
                  Choose a sector from the stadium layout above
                </p>
              </div>
            ) : (
              <div style={{ animation: 'fadeInUp 0.35s ease forwards' }}>
                <h2 style={{
                  fontFamily: 'Bebas Neue',fontWeight:'800' ,fontSize: '34px', margin: 0,
                  color: t.textPrimary, letterSpacing: '1px'
                }}>
                  {selectedStand.name}
                </h2>
                <p style={{
                  fontFamily: 'JetBrains Mono', fontSize: '20px', color: t.primaryBlue,
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
                  <div style={{ background: t.cardBg, padding: '16px', borderRadius: '12px', border: t.cardBorder }}>
                    <small style={{ fontSize: '12px', fontWeight:'1000', color: t.textSecondary, fontFamily: 'JetBrains Mono' }}>
                      REMAINING SEATS
                    </small>
                  ...
                  <div style={{ background: t.priceBg, padding: '16px', borderRadius: '12px', border: t.priceBorder }}>
                    {priceLoading ? (
                      ...
                      <>
                        <small style={{ fontSize: '16px',fontWeight:'900', color: t.primaryBlue, fontFamily: 'JetBrains Mono' }}>CURRENT PRICE</small>
